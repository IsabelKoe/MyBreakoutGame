...
const brickWidth = canvas
  ? Math.floor((canvas.width - canvasPadding * 2) / canvasColumns) -
    brickPadding
  : 100;
const brickHeight = canvas
  ? Math.floor((canvas.height - canvasPadding * 2) / canvasRows) - brickPadding
  : 30;
