...
export const exitName = document.querySelector("#close-name-modal") as HTMLElement;
export const nameModal = document.querySelector("#name-modal") as HTMLElement;
export const nameModalContent = document.querySelector(".name-modal-content") as HTMLElement;
export const nameInput = document.querySelector(".name-input") as HTMLInputElement;
...
export const helpModalContent = document.querySelector(".help-modal-content") as HTMLElement;
